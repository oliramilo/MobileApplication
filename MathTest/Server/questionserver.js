...
const IMAGE_REQUEST_PATH = "image/receive/"
...
function requestHandler(request, response)
{
    ...
    else
    {
        ...
        else if(reqUrl.pathname === IMAGE_UPLOAD_PATH) {
            if(request.method != "POST") {
                console.log("Only POST requests for image upload is allowed, rejecting request.");
